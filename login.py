...
class Pass:
    ...
    def registration(self):
        ...
        if len(us) < 10 > 20:
            print("Username has wrong lenth, it need to be from 10 to 20 char!")
    ...
    def log_in(self):
        ...
        pas = input("FIll this gap with your password")
...
def main():
    ...
    while True:
        ...
        log = input("Print 1 if you already have account.\nPrint  2 if you want to registrate an account:")
        if log == 1:
            app.log_in()
        elif log == 2:
            app.registration()
